...
const Features = ({ display }: AddContentProps) => {
	return (
		<section className={`flex flex-col gap-16 md:pt-10 lg:pt-24 pb-24 lg:px-8 xl:px-24 px-4 max-w-screen-2xl mx-auto ${display && "hidden"}`}>
			...
			<div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-20">
				{featuresData.map((item) => (
					<div className="flex flex-col items-center justify-center gap-2 max-w-full sm:max-w-sm" key={item.title}>
