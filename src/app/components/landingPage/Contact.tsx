...
export const Contact = () => {
	return (
		<section className="relative py-24 md:px-24 px-8 max-w-screen-2xl mx-auto">
			...
			<Image className="absolute max-w-screen-sm bottom-0 right-[-10px] " src={ContactImage} alt="ContactImage" />
		</section>
	);
};
...
export const ContactPromo = () => {
	return (
		<section className="relative py-24 max-w-screen-2xl mx-auto overflow-hidden">
			<div className="flex flex-col items-center gap-16 px-8 md:px-0">
				<Reveal1>
			...
			<Image className="absolute bottom-0 right-0" src={Ornament} alt="Ornament" />
			<Image className="absolute top-0 left-0 rotate-180" src={Ornament} alt="Ornament" />
		</section>
	);
};
