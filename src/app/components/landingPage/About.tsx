  ...
  return (
    <section className="bg-[#F6E5F7] flex flex-col md:flex-row gap-24 items-center justify-between py-24 lg:px-8 xl:px-24 px-4 max-w-screen-2xl mx-auto">
      <div className="flex flex-col gap-8 max-w-4xl">
        <Reveal1>
          <h2>
            The ultimate all-in-one solution designed for African businesses.
          </h2>
        </Reveal1>
        <Reveal3>
          <p>
            PurpleDove ERP is designed to streamline your business operations;
            From account to inventory, payroll to asset, finance to HR, CRM to
            Sales, experience an intuitive and powerful ERP solution that scales
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="font-medium text-black">
            We are in compliance with the Nigeria Data Protection Requirements
          </div>
        </div>
      </div>
      ...
      <div className="hidden md:visible">
        <div className="relative w-[201px] h-[201px] rounded-full flex items-center justify-center">
          ...
          <div className="animate-text absolute w-full h-full">
            {animatedText}
          </div>
        </div>
      </div>
  ...
  return (
    <section className="bg-[#F6E5F7] grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-28 items-center justify-between py-24 lg:px-8 xl:px-24 px-4 max-w-screen-2xl mx-auto">
      ...
      <div className="flex flex-col gap-8 max-w-4xl">
        <Reveal1>
          <h2>
            Are you ready to elevate your business to new heights of efficiency
            and productivity?{" "}
          </h2>
        </Reveal1>
        <Reveal3>
          <p>
            PurpleDove ERP is an all-in-one ERP system tailored to meet your
            unique needs, streamline your operations, and drive unparalleled
            growth. With PurpleDove ERP, you can manage everything including
            accounting, payroll, inventory, assets, projects, customer
            relationship management (CRM), human resource management, sales,
            procurement, data analytics, point-of-sale (POS), custom reporting,
            quality control, and manufacturing within a user-friendly and
